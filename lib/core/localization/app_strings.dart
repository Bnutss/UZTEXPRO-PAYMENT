...
class S {
  ...
  String get comingSoon => _t(
      {'ru': 'Скоро будет доступно', 'en': 'Coming soon', 'uz': 'Tez orada'});
  ...
  String get paymentStatus => _t(
      {'ru': 'Статус платежа', 'en': 'Payment status', 'uz': "To'lov holati"});
  ...
  String get enterAmount => _t(
      {'ru': 'Введите сумму', 'en': 'Enter amount', 'uz': 'Summani kiriting'});
  ...
  String get updating => _t(
      {'ru': 'Обновление...', 'en': 'Updating...', 'uz': 'Yangilanmoqda...'});
  ...
  String get authenticate => _t(
      {'ru': 'Аутентификация', 'en': 'Authenticate', 'uz': 'Autentifikatsiya'});

  String get authReason => _t({
        'ru':
            'Используйте биометрию для доступа к настройкам конфиденциальности',
